...
@Component({
  selector: 'app-ip-payment-rules',
  standalone: true,
  imports: [DatePipe, RouterLink, FormsModule, ButtonModule, TableModule],
  templateUrl: './ip-payment-rules.component.html',
  styleUrl: './ip-payment-rules.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class IpPaymentRulesComponent {
