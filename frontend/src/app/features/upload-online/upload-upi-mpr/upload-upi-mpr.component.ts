...
@Component({
  selector: 'app-upload-upi-mpr',
  standalone: true,
  imports: [ButtonModule],
  templateUrl: './upload-upi-mpr.component.html',
  styleUrl: './upload-upi-mpr.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class UploadUpiMprComponent {
  ...
  protected upload(): void {
    ...
    from(files)
      .pipe(
        concatMap((file) =>
          this.ucrUpload.uploadUpiMpr(file, this.auth.userId()).pipe(
  ...
  protected viewUpiRecon(): void {
    this.router.navigate(['/matched-rules/upi-reconciliation']);
  }
