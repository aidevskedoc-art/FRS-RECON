...
@Component({
  selector: 'app-upload-easebuzz',
  standalone: true,
  imports: [ButtonModule],
  templateUrl: './upload-easebuzz.component.html',
  styleUrl: './upload-easebuzz.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class UploadEasebuzzComponent {
  ...
  protected upload(): void {
    ...
    from(files)
      .pipe(
        concatMap((file) =>
          this.bankStatements.uploadEasebuzz(file, this.auth.userId()).pipe(
  ...
  protected viewBatches(): void {
    this.router.navigate(['/upload-online/easebuzz']);
  }
