...
@Component({
  selector: 'app-upload-card-pinelabs',
  standalone: true,
  imports: [ButtonModule],
  templateUrl: './upload-card-pinelabs.component.html',
  styleUrl: './upload-card-pinelabs.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class UploadCardPinelabsComponent {
  ...
  protected upload(): void {
    ...
    from(files)
      .pipe(
        concatMap((file) =>
          this.ucrUpload.uploadCardPinelabs(file, this.auth.userId()).pipe(
