...
@Component({
  selector: 'app-upload-card-mpr',
  standalone: true,
  imports: [ButtonModule],
  templateUrl: './upload-card-mpr.component.html',
  styleUrl: './upload-card-mpr.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class UploadCardMprComponent {
  ...
  protected upload(): void {
    ...
    from(files)
      .pipe(
        concatMap((file) =>
          this.ucrUpload.uploadCardMpr(file, this.auth.userId()).pipe(
