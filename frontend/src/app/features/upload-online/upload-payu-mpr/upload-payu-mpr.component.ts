...
@Component({
  selector: 'app-upload-payu-mpr',
  standalone: true,
  imports: [ButtonModule],
  templateUrl: './upload-payu-mpr.component.html',
  styleUrl: './upload-payu-mpr.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class UploadPayuMprComponent {
  ...
  protected upload(): void {
    ...
    from(files)
      .pipe(
        concatMap((file) =>
          this.bankStatements.uploadMpr(file, this.auth.userId()).pipe(
  ...
  protected viewBatches(): void {
    this.router.navigate(['/upload-online/payu-mpr']);
  }
