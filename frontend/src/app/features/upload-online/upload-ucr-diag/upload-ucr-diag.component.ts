...
@Component({
  selector: 'app-upload-ucr-diag',
  standalone: true,
  imports: [ButtonModule],
  templateUrl: './upload-ucr-diag.component.html',
  styleUrl: './upload-ucr-diag.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class UploadUcrDiagComponent {
  ...
  protected upload(): void {
    ...
    from(files)
      .pipe(
        concatMap((file) =>
          this.ucrUpload.uploadUcrDiag(file, this.auth.userId()).pipe(
